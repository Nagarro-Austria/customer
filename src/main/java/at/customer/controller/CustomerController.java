...
public class CustomerController {
    ...
    Customer newCustomer(
        ...
        Customer customer;
        checkNameNotEmpty(firstName, lastName);
        try {
            customer = repository.save(new Customer(firstName, lastName));

        } catch (Exception e) {
            throw new CustomerDuplicateNameException(firstName, lastName);
        }
        return customer;
    }

    private void checkNameNotEmpty(String firstname, String lastname) {
        if (firstname.isEmpty() || lastname.isEmpty()){
            throw new CustomerNameNotNullException(firstname, lastname);
        }
    }
